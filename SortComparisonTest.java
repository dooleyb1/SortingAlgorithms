...
public class SortComparisonTest
{
 ...
 // ----------------------------------------------------------
    ...
    {
        File tenFile = new File("./test_files/numbers10.txt");
        double[] array10 = SortComparison.populateArray(tenFile, 10);
    	
    	File hundredFile = new File("./test_files/numbers100.txt");
    	double[] array100 = SortComparison.populateArray(hundredFile, 100);

    	File thousandFile = new File("./test_files/numbers1000.txt");
    	double[] array1000 = SortComparison.populateArray(thousandFile, 1000);
    	
    	File thousandDuplicates = new File("./test_files/numbers1000Duplicates.txt");
    	double[] array1000Duplicates = SortComparison.populateArray(thousandDuplicates, 1000);
        
    	File thousandNearlyOrdered = new File("./test_files/numbersNearlyOrdered1000.txt");
    	double[] array1000NearlyOrdered = SortComparison.populateArray(thousandNearlyOrdered, 1000);
    	
    	File thousandReverse = new File("./test_files/numbersReverse1000.txt");
    	double[] array1000Reverse = SortComparison.populateArray(thousandReverse, 100);
    	
    	File thousandSorted = new File("./test_files/numbersSorted1000.txt");
